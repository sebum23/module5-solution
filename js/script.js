...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      console.log(chosenCategory.short_name);
...
function buildAndShowAboutHTML (aboutHtml) {
  ...
  for (let i = 1; i < 6; i ++) {
    ...
    aboutHtml = insertProperty(aboutHtml, className, i <= randomNumber ? "fa fa-star" : "fa fa-star-o");
  }
  aboutHtml = insertProperty(aboutHtml, "starRating", `${randomNumber}-star rating`)
